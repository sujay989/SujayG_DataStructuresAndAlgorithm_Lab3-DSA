...
import com.greatlearning.brackets.balancer.Bracket;
import com.greatlearning.brackets.balancer.BracketsManager;
...
public class BalancedBracketsChecker {
	...
	public Result check() {
		...
		Set<Character> closeBracketsSet = BracketsManager.getCloseBracketCharsSet();
